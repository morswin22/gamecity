...
function render($path, $args = array()) {
    global $twig, $previous_page, $router__default_data; 
    $args['previous_page'] = $previous_page;
    echo $twig->render($path, array_merge($router__default_data, $args));
}

$router__default_data = array();
function default_data($args) {
    global $router__default_data;
    $router__default_data = $args;
}
